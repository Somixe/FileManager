...
export default function forgotPassword() {
    ...
    <SafeAreaView style={styles.safeArea}>
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <Text style = {styles.noWorriesText}>No worries! It happens. Please enter your account email address.</Text>
            ...
            {/* Bouton Login */}
            <TouchableOpacity style={styles.submitButton}   onPress={() => router.push({ pathname: '/codeForgotPassword', params: { email } })}>
